...
const stateMeta: Record<FieldState, { label: string; className: string; icon: React.ReactNode }> = {
  ...
  pending: {
    label: 'Ожидает',
    className: 'bg-[#3a45b4]/10 border-[#3a45b4]/20 text-[#8fa3ff]',
...
function FieldReviewRow({ field, onAddRemark }: { field: (typeof fields)[number]; onAddRemark: (field?: string) => void }) {
  ...
  return (
    <div className={`p-4 rounded-2xl border transition-colors ${field.state === 'warning' ? 'bg-orange-500/5 border-orange-500/30' : 'bg-[#161617] border-[#242529] hover:border-[#2e2f34]'}`}>
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="h-9 px-3 rounded-xl bg-orange-500/10 hover:bg-orange-500/15 border border-orange-500/20 text-orange-400 text-[12px] font-medium flex items-center gap-1.5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500"
          >
            <MessageSquarePlus className="w-4 h-4" /> Замечание
          </button>
          <button className="h-9 px-3 rounded-xl bg-emerald-500/10 hover:bg-emerald-500/15 border border-emerald-500/20 text-emerald-400 text-[12px] font-medium flex items-center gap-1.5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500">
    ...
    >
      <header className="h-[64px] shrink-0 border-b border-[#202124] bg-[#141416]/95 backdrop-blur-md flex items-center px-4 lg:px-6 gap-4">
        ...
        <div className="min-w-0">
          <div className="text-[11px] text-orange-400 uppercase tracking-wider font-medium">Admin document review</div>
        ...
        <div className="ml-auto hidden md:flex items-center gap-2">
          ...
          <button className="h-10 px-4 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-[13px] font-medium text-white flex items-center gap-2 shadow-[0_0_20px_rgba(16,185,129,0.18)] transition-colors">
        ...
        <section className="min-h-[420px] xl:min-h-0 bg-[#0e0e10] border-b xl:border-b-0 xl:border-r border-[#202124] flex flex-col">
          ...
          <div className="flex-1 min-h-0 p-5 lg:p-8 overflow-auto scrollbar-thin scrollbar-thumb-white/10 flex items-center justify-center">
            <div className="relative w-full max-w-[560px] aspect-[0.72] rounded-[24px] bg-gradient-to-b from-[#f7f7f1] to-[#d8d8cd] shadow-[0_32px_120px_rgba(0,0,0,0.5)] overflow-hidden text-[#101011] p-8">
              <div className="absolute inset-x-0 top-0 h-20 bg-gradient-to-r from-blue-900/20 via-red-700/10 to-blue-900/20" />
              ...
              <div className="relative z-10 grid grid-cols-[150px_1fr] gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="inline-flex items-center gap-2 text-[14px] font-bold px-2 py-1 rounded-md bg-orange-500/20 border border-orange-500/40">MOSCOW <AlertCircle className="w-3.5 h-3.5 text-orange-700" /></div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute left-[235px] top-[270px] w-[188px] h-[42px] rounded-xl border-2 border-orange-500/70 bg-orange-500/10 shadow-[0_0_0_4px_rgba(249,115,22,0.08)]" />
            </div>
          </div>
        </section>
