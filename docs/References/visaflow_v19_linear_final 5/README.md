...
## LinearStyle Final Pass — 2026-07-03

Added:
- Full Applicants / Families workspace with summary, filters, family rows, individual profiles, readiness meters.
- Full Settings workspace with organization, visual mode, security, notifications, automation, team and export-readiness panels.
- Muted LinearStyle color system: monochrome first, purple accent second, red/yellow only for real risk.
