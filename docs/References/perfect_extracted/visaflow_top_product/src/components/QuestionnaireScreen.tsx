...
import {
  ...
  Calendar, MapPin, Building2, Mail, Phone, Sparkles
} from 'lucide-react';
    ...
    >
      <header className="h-[64px] shrink-0 border-b border-[#202124] bg-[#141416]/95 backdrop-blur-md flex items-center px-4 lg:px-6 gap-4">
        ...
        <div className="ml-auto hidden md:flex items-center gap-2">
          ...
          <button className="h-10 px-4 rounded-xl bg-[#6f64ff] hover:bg-[#4855d4] text-[13px] font-medium text-white flex items-center gap-2 shadow-[0_0_20px_rgba(58,69,180,0.25)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white">
        ...
        <aside className="border-r border-[#202124] bg-[#141416] p-4 lg:p-5 overflow-y-auto scrollbar-thin scrollbar-thumb-white/10">
          <div className="mb-5 p-4 rounded-2xl border border-[#242529] bg-gradient-to-br from-[#1a1a1d] to-[#141416]">
            ...
            <div className="flex items-end justify-between mb-2">
              ...
              <div className="text-[12px] text-white/62 font-medium">2 риска</div>
            </div>
            <div className="h-2 rounded-full bg-white/5 overflow-hidden">
              <div className="h-full w-[86%] bg-[#6f64ff] rounded-full" />
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_340px] gap-5">
              <div className="space-y-3">
                {active.fields.map((field) => (
                  <div key={field.label} className={`p-4 rounded-2xl border bg-[#161617] transition-colors ${field.state === 'warning' ? 'border-white/10 bg-white/[0.035]' : 'border-[#242529] hover:border-[#2e2f34]'}`}>
                    <div className="flex flex-col md:flex-row md:items-center gap-4 justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button className="h-9 px-3 rounded-lg bg-white/[0.045] hover:bg-[#202126]/15 border border-white/10 text-[12px] font-medium text-[#b8baff] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6f64ff]/60">Подтвердить</button>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <aside className="space-y-4">
                ...
                <div className="p-5 rounded-2xl bg-gradient-to-br from-[#1a1a1d] to-[#141416] border border-[#242529]">
                  ...
                  <button className="w-full h-10 rounded-xl bg-[#6f64ff] hover:bg-[#4855d4] text-[13px] font-medium text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white">
