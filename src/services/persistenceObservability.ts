export type SupabasePersistenceOperation =
  ...
  | "workbook_export_receipts.list"
  | "workbook_export_receipt_members.list"
  | "rpc.complete_export_package"
  | "rpc.complete_workbook_export"
  | "rpc.begin_agent_submission_deletion"
  | "rpc.mark_agent_submission_deletion_cleanup_started"
  | "rpc.cancel_agent_submission_deletion"
  | "rpc.finalize_agent_submission_deletion"
  | "rpc.reconcile_workbook_export"
  | "rpc.record_export_workbook_download_acknowledgement"
  ...
  | "storage.delete_submission_assets.submission-files"
  | "storage.delete_submission_assets.submission-media"
