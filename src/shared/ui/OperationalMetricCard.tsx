...
export function OperationalMetricCard({
  ...
  return (
    <div className="h-[60px] rounded-[8px] border border-[#242529] bg-gradient-to-br from-[#1a1a1d] to-[#141416] px-3 py-1.5 shadow-sm sm:h-auto sm:min-h-[116px] sm:rounded-2xl sm:p-4">
      ...
      {detail ? <div className="mt-1 hidden text-[11px] text-white/40 sm:block">{detail}</div> : null}
    </div>
  );
}
