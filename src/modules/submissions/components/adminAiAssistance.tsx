...
const figmaSubmissionDrawerStyles = `
  ...
  .v20-tab-indicator {
    ...
    border-radius: var(--v19b-radius-pill);
    background: var(--v19b-admin-drawer-text-70);
    pointer-events: none;
  }
  ...
  /* Source-normalized desktop sheet. Overview and Issues follow the selected
     reference; Questionnaire keeps the existing product component. */
  ...
  .v20-info-title {
    margin: var(--v19b-size-0) var(--v19b-size-0) var(--v19b-size-20);
  }

  .v20-info-line {
    grid-template-columns: var(--v19b-size-20) minmax(
        var(--v19b-size-0),
        var(--v19b-grid-fr)
      );
    gap: var(--v19b-size-16);
  ...
  .v20-empty-state {
    min-height: var(--v19b-size-160);
    padding: var(--v19b-size-24);
    border-color: var(--v19b-admin-drawer-border-faint);
    border-radius: var(--v19b-radius-row);
    color: var(--v19b-color-text-muted);
    background: var(--v19b-admin-drawer-surface);
    font-size: var(--v19b-size-16);
  ...
  .v20-history-icon {
    width: var(--v19b-size-32);
    height: var(--v19b-size-32);
    border-radius: var(--v19b-radius-control);
  }

  .v20-history-icon svg {
    width: var(--v19b-size-16);
    height: var(--v19b-size-16);
  }
...
export function FigmaSubmissionDrawer({
  ...
  const activeTabIndicatorTransition = shouldReduceMotion
    ? { duration: 0.01 }
                  ...
                  >
                    ...
                    {isActive ? (
                      <motion.span
                        ...
                        transition={activeTabIndicatorTransition}
                      />
                    ) : null}
                  </button>
                );
