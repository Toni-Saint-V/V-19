...
export function AdminExportDiagnosticsPanel({
  ...
  return (
    ...
    >
      ...
      {onShowPackage ? (
        <button
          className="linear-product-action linear-product-action--warning linear-product-action--compact mt-3 h-9 rounded-[9px] border border-[var(--v19b-admin-red-border)] bg-[#1e1e21] px-3 text-[12px] font-semibold text-white transition-colors hover:bg-[#27272b] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--v19-depth-focus)]"
