...
export const initialSubmissions: Submission[] = [
  {
    ...
    issues: [
      ...
      issue(
        ...
        "з-1048-3",
        "София Иванова",
        "Видео требует замены",
        "Слишком темное видео, нужно записать заново.",
        "blocker",
        "open",
        "Файлы",
        "video",
    ...
    files: [
      ...
      file("ф-1048-3", "з-1048-1", "video", "accepted"),
      file("ф-1048-4", "з-1048-3", "photo", "accepted"),
      file("ф-1048-5", "з-1048-3", "selfie", "accepted"),
      file("ф-1048-6", "з-1048-3", "video", "needs_replacement", "зм-1048-2"),
    ],
  ...
  },
  {
    ...
    files: [
      ...
      file("ф-1051-3", "з-1051-1", "video", "missing"),
    ],
  ...
  },
  {
    ...
    files: [
      ...
      file("ф-1052-3", "з-1052-1", "video", "missing"),
    ],
  ...
  },
  {
    ...
    files: [
      ...
      file("ф-1053-3", "з-1053-1", "video", "pending_review"),
    ],
  ...
  },
  {
    ...
    files: [
      ...
      file("ф-1056-3", "з-1056-1", "video", "accepted"),
    ],
    completeness: { questionnaire: 100, files: 100, total: 100 },
    exportState: "ready",
    createdAt: "09.06",
  ...
  },
  {
    ...
    files: [
      ...
      file("ф-1057-3", "з-1057-1", "video", "accepted"),
    ],
    completeness: { questionnaire: 100, files: 100, total: 100 },
