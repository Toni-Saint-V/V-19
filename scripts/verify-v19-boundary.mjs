...
const promotedRuntimeFiles = [
  ...
  path.join(root, "src/lib/supabase/resilientFetch.ts"),
  path.join(root, "src/lib/supabase/workspaceRuntime.ts"),
  ...
  path.join(root, "src/services/supabaseInviteFlow.ts"),
  path.join(root, "src/services/supabasePasswordRecovery.ts"),
  path.join(root, "src/types/domain.ts"),
